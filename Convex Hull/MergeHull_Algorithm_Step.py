...
def convex_hull_mh(points):
    ...
    Display hull.
    '''
    #plt.title("Convex Hull of {} random points by MergeHull Algorithm".format(len(points)))
    plt.axis("off")
    display_pts(points)
    display_cx(data1, cvxhull1, "green")
    display_cx(data2, cvxhull2, "red")
    plt.show()
